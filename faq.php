            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
                    ...
                    <div class="content px-xl-5">
                        ...
                        <p>
                            Any queries or doubts regarding the<strong> Placement Pilot </strong> will be addressed over here students might get confused regarding the placement portal and may have may have queries to be solved.
                    </div>
